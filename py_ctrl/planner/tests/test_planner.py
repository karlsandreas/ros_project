...
def test_planner_real_model_full():
    ...
    goal = g("posb1 == blue_cube && posb2 == green_cube && posb3 == red_cube")
    ...
    should_find = set(["r1_to_pos1","r1_grip_pos1","r1_to_home","r2_to_pos2","r2_grip_pos2","r2_to_pos1","r1_to_pos2",
        "r2_drop_pos1","r1_drop_pos2"
